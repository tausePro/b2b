...
function costAgeBadgeClass(status: ProductoOdooCliente['antiguedad_costo_estado']) {
                          ...
                          {typeof producto.standard_price === 'number' && (
                            <div className="mt-1 flex items-center gap-1.5 text-[10px] flex-wrap">
                              {producto.costo_requiere_variantes ? (
                                <span className="text-muted" title="Odoo registra costo y antigüedad por variante para este producto.">
                                  Costo por variante
                                </span>
                              ) : (
                                <>
                                  <span
                                    className={producto.antiguedad_costo_estado === 'danger' ? 'text-red-600 font-semibold' : 'text-muted'}
